...
func (me SqlSessionStore) CreateIndexesIfNotExists() {
	...
	me.CreateIndexIfNotExists("idx_access_token", "Sessions", "AccessToken")
}
...
func (me SqlSessionStore) GetByAccessToken(token string) StoreChannel {
	...
	go func() {
		...
		if err := me.GetReplica().SelectOne(&session, "SELECT * FROM Sessions WHERE AccessToken=?", encryptedToken); err != nil {
